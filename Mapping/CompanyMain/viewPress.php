...
$result = mysqli_query($db, "CALL c_present_mark('".$_GET['Student_Id']."')");
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!--form-->
                                <form action="printPress.php?Student_Id=<?php echo $id; ?>" method="POST" class="form-horizontal" name="form1">
