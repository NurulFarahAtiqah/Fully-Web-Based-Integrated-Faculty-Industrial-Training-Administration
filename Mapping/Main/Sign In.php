<?php
include('../Connections/Login.php'); // Include Login Script
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="">
                        <div class="header header-primary text-center">
                                <h1 class="title text-center">AJK Log In</h1>
                        ...
                        <div class="pull-right">
                            <h6>
                                <a href="Forgot_Password.php" class="alert-link" >Forgot Password?</a>
                            </h6>
                        </div>
                    </form>
                </div>
