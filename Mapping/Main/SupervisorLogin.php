<?php
include('../Supervisor Main/SupervisorLogin.php'); // Include Login Script
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="">
                        <div class="header header-primary text-center">
                                <h1 class="title text-center">Supervisor Log In</h1>
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" id="Supervisor_StaffID"  name="Supervisor_StaffID" placeholder="Staff ID" required/>
                            </div>
                         ...
                         <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="password" placeholder="Password" id="Supervisor_Password" name="Supervisor_Password"  class="form-control" required />
                            </div> 
                       ...
                       <div class="pull-right">
                            <h6>
                                <a href="../Supervisor Main/forgotPass.php" class="alert-link" >Forgot Password?</a>
                            </h6>
                        </div>  
