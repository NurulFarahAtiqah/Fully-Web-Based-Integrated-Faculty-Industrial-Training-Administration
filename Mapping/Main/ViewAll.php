        						...
        						while($row = mysqli_fetch_array($result))
        					   	{
									...
									$finish = $row['Finish_Date'];
          						    ...
          						    echo '<tr>';
                                    $internArray = array("$matric","$stud_name","$stud_ic","$course","$comp_name","$comp_add","$comp_add2","$comp_city","$comp_pos","$comp_state","$comp_phone","$super_name","$super_phone","$start","$finish");
