        ...
        <?php
  			while($row = mysqli_fetch_array($result))
  	    	{
				...
				$issue = $row['Issue'];
  		    	...
  		    	echo '<tr>';
              $stArray = array("$student_matric","$student_name","$company_name","$status","$start","$finish","$issue");
