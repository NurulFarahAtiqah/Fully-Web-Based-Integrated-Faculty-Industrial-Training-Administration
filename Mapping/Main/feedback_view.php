...
if($status=='Done')
{
$query =  "SELECT student.Student_Id,student.Student_Name,student.Student_Matric,student.Student_Course, feedback.time_submit FROM student LEFT JOIN feedback ON student.Student_Id = feedback.Student_Id  WHERE feedback.time_submit IS NOT NULL AND student.semester_session='$session'";
