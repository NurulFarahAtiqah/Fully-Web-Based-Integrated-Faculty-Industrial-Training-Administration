...
{
header("Location: Update_Password.php?Supervisor_StaffID=".$_POST['Supervisor_StaffID']); // Redirecting To Other Page
}else
{
$id = $_POST['Supervisor_StaffID'];
echo "<script>
alert('Wrong Answer ! Please Answer Again');
window.location.href='post.php?Supervisor_StaffID=$id';
</script>";
