...
<body>
  <body>
    <div class="wrapper">
    <?php include "../Supervisor Main/SupervisorNav.php"; ?>
        <div class="main-panel">
          <?php include "../Supervisor Main/SupervisorHeader.php"; ?>
