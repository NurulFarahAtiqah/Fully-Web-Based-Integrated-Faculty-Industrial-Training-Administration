...
$sql="SELECT * FROM student WHERE Security_Question='$sq' and Security_Answer='$ans'";
...
{
header("Location: updatePass.php?Student_Matric=".$_POST['Student_Matric']); // Redirecting To Other Page
}else
{
$id = $_POST['Student_Matric'];
echo "<script>
alert('Wrong Answer ! Please Answer Again');
window.location.href='sq.php?Student_Matric=$id';
</script>";
                    ...
                    <form class="form" method="post" action="sq.php">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" id="Student_Matric"  name="Student_Matric"  value="<?php echo $staffid; ?>" readonly/>
                            </div>
