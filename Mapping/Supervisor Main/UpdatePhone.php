	...
	$ans = $_POST['Supervisor_ans'];
        ...
        //redirectig to the display page. In our case, it is index.php
		 ...
		 echo "<script>
		  ...
		  window.location.href='SupervisorMain.php';
		  </script>"; 
...
$result = mysqli_query($db, "SELECT * FROM supervisor WHERE Supervisor_Id=$login_id");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                	...
                                	<!--Form-->
                                    <form method="post" name="form1" action="UpdatePhone.php">
                                        ...
                                        <div class="row"> <!--ROW1-->
                                            ...
                                            <div class="row">
                                            <div class="col-md-8">
                                            <input type="hidden" name="Supervisor_Id" value=<?php echo $login_id;?>>
