...
{    
	...
	//updating the table
	$result = mysqli_query($db, "UPDATE pre_evaluation SET Q1='$QA1',Q2='$QA2',Q3='$QA3',Q4='$QA4',Q5='$QA5',Q6='$QA6',Q7='$QA7' WHERE Student_Id=$ID");
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!--form-->
                                <form action="updatePre.php" method="POST" class="form-horizontal" name="form1">
								...
								<label class="col-sm-9" for="QA1">(e.g.: Operating system; System application; Web Page; Network; Multimedia application; Database)</label>
                                 <div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" id="QA1" name="QA1" ><?php echo $Q1; ?></textarea>
                                 </div>
                                 </div>
								...
								<label class="col-sm-9" for="QA2">(e.g.: Attending / preparing / conducting meeting / training /course / presentation; Clerical works; Visiting site)</label>
                                 <div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" id="QA2" name="QA2" ><?php echo $Q2; ?></textarea>
                                 </div>
                                 </div>
								...
								<label class="col-sm-7" for="QA3">(e.g.: ICT facilities; Workforce; Size of IT unit)</label>
                                 <div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" id="QA3" name="QA3" ><?php echo $Q3; ?></textarea>
                                 </div>
                                 </div>
								...
								<label class="col-sm-7" for="QA1">(e.g.: Dedicated PC; Room/workspace; Allowance)</label>
                                 <div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" id="QA4" name="QA4" ><?php echo $Q4; ?></textarea>
                                 </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                 <textarea class="col-sm-12" rows="5" id="QA5" name="QA5" ><?php echo $Q5; ?></textarea>
                                 </div>
                                 </div>
                              ...
                              <label class="col-sm-7" for="QA6">Is it suitable for the Industrial Training placement?	</label>
                                ...
                                <div class="col-sm-12">
                                <textarea class="col-sm-12" rows="5" id="QA7" name="QA7" ><?php echo $Q7; ?></textarea>
                                </div> 
                                 </div>
