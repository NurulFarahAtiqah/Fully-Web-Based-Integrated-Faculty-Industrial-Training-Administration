...
{    
	...
	//updating the table
	$result = mysqli_query($db, "UPDATE present_mark SET QA1='$QA1',QB1='$QB1',QB2='$QB2',QB3='$QB3',QB4='$QB4',QB5='$QB5',QC1='$QC1',QC2='$QC2',QC3='$QC3',QD1='$QD1',QD2='$QD2',QD3='$QD3',QD4='$QD4' WHERE Student_Id=$ID");
...
$result1 = mysqli_query($db, 'SELECT student.Student_Name,present_mark.QA1,present_mark.QB1,present_mark.QB2,present_mark.QB3,present_mark.QB4,present_mark.QB5,present_mark.QC1, present_mark.QC2,present_mark.QC3,present_mark.QD1,present_mark.QD2,present_mark.QD3,present_mark.QD4 FROM present_mark INNER JOIN student ON present_mark.Student_Id = student.Student_Id WHERE present_mark.Student_Id = "'.$id.'"');
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!--form-->
                                <form action="update_pres.php" method="POST" class="form-horizontal" name="form1">
